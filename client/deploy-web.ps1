...
Write-Host "SUCCESS: Static assets synced successfully" -ForegroundColor Green
Write-Host ""
...
Write-Host "SUCCESS: HTML files synced successfully" -ForegroundColor Green
Write-Host ""
...
Write-Host "SUCCESS: CloudFront invalidation created: $invalidationId" -ForegroundColor Green
Write-Host ""
