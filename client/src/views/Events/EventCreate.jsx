...
const EventCreate = () => {
  ...
  const [eventVisibility, setEventVisibility] = useState(null) // Defaults to parent business visibility
  ...
  useEffect(() => {
    ...
    const fetchBusinessData = async () => {
      try {
        ...
        // Default event visibility to parent business's visibility
                      ...
                      <div style={{ flex: '1' }}>
                        ...
                        <div 
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              const [hours, minutes] = e.target.value.split(':');
                              let updatedEnd = moment(item.endDate || new Date()).hour(parseInt(hours)).minute(parseInt(minutes));
                              
                              // Automatic next-day detection for overnight events
                              if (item.startDate && updatedEnd.isBefore(moment(item.startDate))) {
                                updatedEnd = updatedEnd.add(1, 'day');
                              }
            ...
            <div style={{ width: '100%', marginTop: '20px' }}>
              ...
              <div style={{
                ...
                {eventVisibilityOptions
                  .filter(option => {
                    // Only show 'organization' option if business is linked to an org
                    if (option.id === 'organization') {
                      return !!(businessData?.organizationId);
                    }
                    return true;
                  })
                  .map(option => (
                    <span
                      ...
                      style={{ 
                        ...
                        padding: '10px 14px',
                        borderRadius: '10px',
                        border: (eventVisibility || businessData?.visibility || 'public') === option.id 
                          ? '2px solid #00AAD6' 
                          : '1.5px solid #E0E0E0',
                        backgroundColor: (eventVisibility || businessData?.visibility || 'public') === option.id 
                          ? '#F0F9FF' 
                          : '#FFFFFF',
                        transition: 'all 0.2s ease',
                      }}
                      onClick={() => setEventVisibility(option.id)}
                    >
                      <div
                        style={{
                          width: '20px',
                      ...
                      >
                        <img
                          style={{justifySelf: "flex-end"}}
                          src={(eventVisibility || businessData?.visibility || 'public') === option.id ? selectIconActive : selectIcon}
                          alt='bullet'
                        />
                      </div>
                      <div>
              ...
              <div style={{
                ...
                <div
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    padding: '14px',
                    border: tickets[0]?.option === 'Tabs Tickets' ? '2px solid #00AAD6' : '1.5px solid #E0E0E0',
                    borderRadius: '12px',
                    backgroundColor: tickets[0]?.option === 'Tabs Tickets' ? '#F0F9FF' : '#FFFFFF',
                    cursor: 'pointer',
                    transition: 'all 0.2s ease',
                    boxShadow: tickets[0]?.option === 'Tabs Tickets' ? '0 2px 8px rgba(0, 170, 214, 0.15)' : '0 1px 4px rgba(0, 0, 0, 0.08)',
                    width: '180px',
                    minHeight: '140px'
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    padding: '14px',
                    border: tickets[0]?.option === 'External link' ? '2px solid #00AAD6' : '1.5px solid #E0E0E0',
                    borderRadius: '12px',
                    backgroundColor: tickets[0]?.option === 'External link' ? '#F0F9FF' : '#FFFFFF',
                    cursor: 'pointer',
                    transition: 'all 0.2s ease',
                    boxShadow: tickets[0]?.option === 'External link' ? '0 2px 8px rgba(0, 170, 214, 0.15)' : '0 1px 4px rgba(0, 0, 0, 0.08)',
                    width: '180px',
                    minHeight: '140px'
                  }}
                >
                ...
                <div
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    padding: '14px',
                    border: tickets[0]?.option === 'Free' ? '2px solid #00AAD6' : '1.5px solid #E0E0E0',
                    borderRadius: '12px',
                    backgroundColor: tickets[0]?.option === 'Free' ? '#F0F9FF' : '#FFFFFF',
                    cursor: 'pointer',
                    transition: 'all 0.2s ease',
                    boxShadow: tickets[0]?.option === 'Free' ? '0 2px 8px rgba(0, 170, 214, 0.15)' : '0 1px 4px rgba(0, 0, 0, 0.08)',
                    width: '180px',
                    minHeight: '140px'
                  }}
                >
